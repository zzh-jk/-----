...
// 自定义上传图片
    ...
    sumbitEditRow() {
      ...
      this.tableData[editData].institution = this.editForm.institution;
      this.tableData[editData].id = this.editForm.id;
      this.tableData[editData].number = this.editForm.number;
      this.tableData[editData].detail = this.editForm.detail;
    ...
    updated() {
      return this.$axios({
        url: 'http://43.138.244.227:8080/getVactivity',
        method: 'GET'
        // params: {
